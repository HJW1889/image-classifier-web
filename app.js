...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // ===== 안전 체크 =====
  if (!fileInput || !preview || !btn) {
    console.error("필수 요소를 찾을 수 없습니다. HTML ID 확인 필요.");
    return;
  }
  ...
  btn.addEventListener("click", async () => {
    ...
    setTimeout(() => {
      ...
      // 예시 출력
      result.textContent = "결과: Cotton (면)";
      resultText.textContent = "면 섬유는 통기성과 흡습성이 높습니다.";

      // progress bar 표시
      progressBars.style.opacity = 1;
      progressBars.style.transform = "translateY(0)";

      progressBars.innerHTML = `
        <div class="progress-row">
          <span class="progress-label">Cotton</span>
          <div class="progress-wrapper">
        ...
        <div class="progress-row">
          <span class="progress-label">Wool</span>
          <div class="progress-wrapper">
      ...
      shopLinks.innerHTML = `
        <a href="https://www.naver.com" target="_blank">Cotton 소재 옷 보기</a>
      `;
